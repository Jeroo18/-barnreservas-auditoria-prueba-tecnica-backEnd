...
//        public IMAPOSPDbContext MAPOSPDbContext;
...
//            var options = new DbContextOptionsBuilder<MockMAPOSPDbContext>()
//                .UseInMemoryDatabase(databaseName: "MAP.OSPInMemory")
//                .Options;

//            MAPOSPDbContext = new MockMAPOSPDbContext(options);                   
...
//                    .AddClasses()
//                    .AsMatchingInterface())
//                .AddSingleton(_ => MAPOSPDbContext)
